    ...
    <>
      ...
      <Panel title="Accounts flow" className="mt-6">
        <p className="mb-4 text-sm text-muted-foreground">
          Super Admin confirms price → Supervisor confirms or adds vehicle → you enter invoice details & raise bill → allot driver on Order desk → delivery → payment → receivable closed.
        </p>
